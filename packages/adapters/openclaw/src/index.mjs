...
export const adapterCapability = Object.freeze({
  ...
  kind: "adapter",
  description: "Describe OpenClaw adapter registration metadata without connecting to OpenClaw.",
...
export const adapterRegistration = Object.freeze({
  ...
  enabled: false,
  external: true,
  description: "Metadata-only OpenClaw adapter registration stub.",
